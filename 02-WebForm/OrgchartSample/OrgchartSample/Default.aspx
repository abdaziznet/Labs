<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="OrgchartSample._Default" %>
...
<head runat="server">
    ...
    <script type="text/javascript" src="Scripts/jquery.jOrgChart.js"></script>
                    ...
                    <ul>
                        ...
                        <li>Berries
                            ...
                            <ul>
                                <li>Blueberry</li>
                                <li>
                                    <img src="images/raspberry.jpg" alt="Raspberry" /></li>
                                <li>Cucumber</li>
                            </ul>
                        </li>
                    </ul>
